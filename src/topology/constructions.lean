...
le_antisymm
  ...
  (le_inf
    (coinduced_le_iff_le_induced.mp $ generate_from_le $ assume u hu,
    ...
    (coinduced_le_iff_le_induced.mp $ generate_from_le $ assume v hv,
...
begin
  ...
  refine le_antisymm (generate_from_mono _) (generate_from_le _),
